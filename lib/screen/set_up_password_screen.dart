      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Spacer(),
            Center(child: CustomButton(text: "SUBMIT",textStyle: TextStyle(fontSize: 16,fontWeight: FontWeight.bold), foregroundColor: DefaultColor.white, backgroundColor: DefaultColor.light_blue, padding: EdgeInsets.symmetric(horizontal: MediaQuery.of(context).size.width*0.35,vertical: 20), callback: (){Navigator.pushNamed(context, "/SetUpPasswordScreen");})),
