...
class VEarningScreen extends StatefulWidget {
  const VEarningScreen({Key? key}) : super(key: key);

  @override
  State<VEarningScreen> createState() => _VEarningScreenState();
}

class _VEarningScreenState extends State<VEarningScreen> {
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Updated Today 8pm",
                    style: TextStyle(color: Colors.grey.shade600, fontSize: 13, fontFamily: "Lato",
                    ),
                  ),
                  const SizedBox(
                    height: 20,
                  ...
                  CustomButton(
                      ...
                      callback: () {
                        Navigator.pushNamed(context, "/v_sendMoneyScreen");
                      }),
                  const SizedBox(
                    height: 20,
                  ),
                        ...
                        return Padding(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                boxShadow: [
                                  BoxShadow(
                                    ...
                                    spreadRadius: 0.5,
                                    blurRadius: 2,
                                    offset: Offset(0, 1.5), // vertical offset
                                  ),
                                ],
                                color: Colors.white,
                            ...
                            child: ListTile(
                              ...
                              title: Text(value['name'].toString(),style: const TextStyle(fontSize: 17,fontWeight: FontWeight.bold,fontFamily: "Inter",
                              )),
                              subtitle: Text(value['date'].toString(),style: TextStyle(fontFamily: "Inter")),
                              trailing: Text(value['rate'].toString(),style: const TextStyle(fontSize: 16,color:DefaultColor.light_blue,fontWeight: FontWeight.w500,fontFamily: "Poppins"),),
                            ),
                          ),
                        );
                      }).toList()
