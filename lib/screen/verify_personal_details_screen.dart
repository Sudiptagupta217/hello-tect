            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Center(child: CustomButton(text: "NEXT",textStyle: TextStyle(fontSize: 16,fontWeight: FontWeight.bold), foregroundColor: DefaultColor.white, backgroundColor: DefaultColor.light_blue, padding: EdgeInsets.symmetric(horizontal: MediaQuery.of(context).size.width*0.37,vertical: 20), callback: (){Navigator.pushNamed(context, "/PaymentDetailsScreen");})),
                  SizedBox(height: 20,),
