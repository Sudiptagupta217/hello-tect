...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void onSwitchChanged(bool newValue) {
    ...
    if (newValue) {
      Navigator.pushNamed(context, '/v_splash');
    }
  }
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                                ...
                                InkWell(
                                  ...
                                  child: Container(
                                      ...
                                      child: const Text("Complete Your KYC",
                                          style: TextStyle(fontSize: 11,fontFamily: "Raleway",fontWeight: FontWeight.bold,color: Colors.black87))),
                                ),
                                Spacer(),
                                InkWell(
                                  onTap: (){
                            ...
                            Text("Hi, John Doe", style: TextStyle(fontSize: 20,fontFamily: "Poppins",fontWeight: FontWeight.bold),),
                            Text("@johndoe234", style: TextStyle(fontSize: 12,fontFamily: "Poppins",color:  Colors.grey),),
                           ...
                           Spacer(),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "Switch To Vendor",
                                  style: TextStyle(color: DefaultColor.light_grey,fontFamily: "Poppins", fontSize: 12),
                                )
                              ],
                            ),
                ...
                children: [
                  InkWell(
                    ...
                    child: Container(
                      width:MediaQuery.of(context).size.width,
                        ...
                        child: Text(" My Plans", style: TextStyle(fontSize: 17,fontFamily: "Raleway", fontWeight: FontWeight.bold),)),
                  ),
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: const [
                            Text("My Bookings", style: TextStyle(fontSize: 17,fontFamily: "Raleway", fontWeight: FontWeight.bold,color: DefaultColor.light_blue),),
                            Spacer(),
                  ...
                  InkWell(
                    ...
                    child: Container(
                      width: MediaQuery.of(context).size.width,
                        padding: EdgeInsets.only(left: 50),
                        child: Text("Refer & Earn", style: TextStyle(fontSize: 17,fontFamily: "Raleway", fontWeight: FontWeight.bold),)),
                  ),
                  const SizedBox(height: 35,),
                  Container(
                      padding: EdgeInsets.only(left: 50),
                  ...
                  Center(
                    child: Container(
                      ...
                      child: CustomButton(text: "LOGOUT",
                          textStyle: TextStyle(fontFamily: "Raleway",fontWeight: FontWeight.w600),
